...
function Controls.search(parent, options)
	...
	panel.entry = Controls.field(panel, {
		...
		leadingIcon = options.searchIcon or "sik.search.24",
		trailingActionIcon = options.clearIcon or "sik.close.24",
		iconSize = 24, iconPadding = math.max(8, n(options.iconPadding, 8)),
